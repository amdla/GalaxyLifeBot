from const_values import ATTACK_BUTTON, FIND_TARGET_BUTTON, FIGHT_NOW_BUTTON, TRAINING_CAMP_1_BUTTON, \
    TRAINING_CAMP_2_BUTTON, CLOSE_TRAINING_VIEW_BUTTON, SPEED_UP_X2_BUTTON, END_BATTLE_BUTTON, GO_HOME_BUTTON, \
    ADD_LOOTERS_TO_TRAINING_LIST_BUTTON, CHOOSE_LOOTER_UNIT_WHEN_ATTACKING_BUTTON
